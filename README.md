...
**any** টাইপ যতটা সম্ভব **এড়ানো উচিত**।

---

## **2. unknown — নিরাপদ any**

`unknown` হলো `any`-এর নিরাপদ ভার্সন।
...
`never` সেই টাইপ যা **কখনোই ঘটে না (অসম্ভব কেস)** এমন কিছু বোঝায়।
...
* **any** → শক্তিশালী কিন্তু বিপজ্জনকসব। টাইপ-চেক বন্ধ করে দেয়।
* **unknown** → নিরাপদ any, টাইপ-চেক করতে বাধ্য করে।
* **never** → এমন টাইপ যার কোনো মানই নেই বা যা কখনোই হবে না বোঝায় (error বা infinite loop অবস্থায়)
